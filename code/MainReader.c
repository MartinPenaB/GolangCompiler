 ...
 * -------------------------------------------------------------
 */
gos_void bErrorPrint(string fmt, ...);
gos_void displayBuffer(Buffer* ptr_Buffer);
gos_long getFileSize(string fname);
int32 isNumber(const string ns);
gos_void startReader(string, string, rune, int32, int32);
...
************************************************************
*/
gos_void startReader(string program, string input, rune mode, int32 size, int32 increment) {
